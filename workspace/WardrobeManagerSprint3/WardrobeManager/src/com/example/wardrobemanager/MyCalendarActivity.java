...
public class   MyCalendarActivity extends Activity implements OnClickListener {
	...
	ArrayList<HashMap<String, String>> alistFirst = new ArrayList<HashMap<String,String>>();
	...
	public class GridCellAdapter extends BaseAdapter  
	{
		...
		private void printMonth(int mm, int yy) 
		{
			...
			{
				Log.d("HERE "+currentMonthName, String.valueOf(i) + " "
				...
				else
				{
					...
					hmap.put("date",String.valueOf(i) + "-"
							+ getMonthAsString(currentMonth) + "-" + yy);
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			for (int i = 0; i < list.size(); i++)
			{
				...
				String[] day_color1 = list.get(i).split("-");
				...
				/*hmap.put("date",theday1 + "-" + themonth1 + "-" + theyear1 );

				alistFirst.add(hmap);	*/

			}
			//System.out.println("FIRST LIST "+ alistFirst);
			...
			//System.out.println("A LIST "+ alistFirst);

			if(alist.size() > 0)
			{
				for (int i = 0; i < alistFirst.size(); i++)
				{
					HashMap<String, String> hmap = new HashMap<String, String>();

					hmap.put("date", String.valueOf(alistFirst.get(i).get("date")));

					if (alist.contains(hmap))
					{
						String date1 = String.valueOf(alistFirst.get(i).get("date"));
