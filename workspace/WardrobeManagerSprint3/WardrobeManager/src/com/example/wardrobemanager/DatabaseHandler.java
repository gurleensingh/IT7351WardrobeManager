...
public class DatabaseHandler extends SQLiteOpenHelper
{
	...
	public long createEntry_for_packing(String item_code ,String base64,String type,String list_name,String id,String title)
	{
		ourDB=this.getWritableDatabase();
			...
			String pic,String itemCode,boolean rainySeason)
	{
		...
		System.out.println("CHAKK DB"+ rainySeason);
	...
	public ArrayList<HashMap<String, String>> getItemsBySearch(String type,String rainySeason,String season) 
	{
		ArrayList<HashMap<String, String>> contactList = new ArrayList<HashMap<String,String>>();
		...
		try
		{
			String query = 
					...
					"SELECT * FROM items_table  where type_of_item like  '%"+type+"%' AND rainy_season like '%"+rainySeason+"%' AND season like '%"+season+"%' ";
	...
	public void forgot_pwd(String login_id ,String password)
	{
		ContentValues cv= new ContentValues();

		cv.put(KEY_EMAIL, login_id); 

		cv.put(KEY_PASSWORD, password);  

		ourDB.update(DATABASE_TABLE_LOGIN, cv, KEY_EMAIL+"='"+login_id+"'", null);
	}
}
